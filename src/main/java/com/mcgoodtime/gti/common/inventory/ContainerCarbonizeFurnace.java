...
public class ContainerCarbonizeFurnace extends Container {
    ...
    public ContainerCarbonizeFurnace(InventoryPlayer playerInv, TileCarbonizeFurnace furnace) {
        this.tileFurnace = furnace;
        this.addSlotToContainer(new Slot(furnace, 0, 56, 17));
        this.addSlotToContainer(new Slot(furnace, 1, 56, 53));
        this.addSlotToContainer(new SlotFurnace(playerInv.player, furnace, 2, 116, 35));
        int i;
    ...
    public ItemStack transferStackInSlot(EntityPlayer p_82846_1_, int p_82846_2_) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            if (p_82846_2_ == 2) {
                ...
                } else if (TileCarbonizeFurnace.isItemFuel(itemstack1)) {
