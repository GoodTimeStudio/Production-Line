...
public class BlockStickyRice extends BlockBush{
	public BlockStickyRice() {
		super(Material.plants);
		this.setBlockName("Gti.Block.StickyRice");
		this.setCreativeTab(creativeTabGti);
		this.setBlockTextureName(Gti.RESOURCE_DOMAIN + ":" + "BlockStickyRice");
