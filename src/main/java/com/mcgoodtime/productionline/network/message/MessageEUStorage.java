...
public class MessageEUStorage extends MessageBase {
    ...
    protected IMessage handlerMessage(MessageBase message, MessageContext ctx) {
        ...
        TileEUStorage tile = (TileEUStorage) ctx.getServerHandler().player.world.getTileEntity(BlockPos.fromLong(pos));
        tile.redstoneMode = mode;
        PLUtil.messageToPlayer(ctx.getServerHandler().player, I18n.translateToLocal("ic2.EUStorage.gui.mod.redstone" + modeID));
        return null;
    }
