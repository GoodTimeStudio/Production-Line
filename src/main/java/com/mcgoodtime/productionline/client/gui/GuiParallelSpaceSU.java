...
import com.mcgoodtime.productionline.inventory.ContainerParallelSpaceSU;
...
public class GuiParallelSpaceSU extends GuiPL<ContainerParallelSpaceSU> {
    ...
    protected void drawGuiContainerForegroundLayer(int x, int y) {
        ...
        this.fontRenderer.drawString("§l" + format("ic2.EUStorage.gui.info.level"), 60, 25, 0x9A00FF);
